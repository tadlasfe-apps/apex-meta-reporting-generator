...
type SharedReport = {
  ...
  report:{id:string;reportMonth:string;dateRange:string;campaigns:Campaign[];draft:Draft;hiddenKpis:string[];metrics:Record<string,number>;status:string;updatedAt:string};
};
